...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Scripts -->
    <script src="{{ mix('js/bootstrap.min.js') }}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{ mix('js/jquery.min.js') }}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{ mix('js/jquery.easing.min.js') }}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{ mix('js/jquery.magnific-popup.js') }}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{ mix('js/popper.min.js') }}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{ mix('js/swiper.min.js') }}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{ mix('js/validator.min.js') }}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
    <script src="{{ mix('js/scripts.js') }}"></script> <!-- jQuery for Bootstrap's JavaScript plugins -->
</body>
</html>